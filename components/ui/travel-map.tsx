...
export function TravelMap({ locations }: TravelMapProps) {
  ...
  useEffect(() => {
    ...
    map.current.on("style.load", () => {
      ...
      // Build GeoJSON from locations — rendered as native WebGL circles
      // so dots are painted directly on the globe surface.
      ...
      // Main colored circles with white stroke
      m.addLayer({
        id: "location-dots",
        type: "circle",
        source: "locations",
      ...
      m.on("mouseenter", "location-dots", (e) => {
